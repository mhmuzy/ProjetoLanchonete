<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="res_con_socio_alt.aspx.cs" Inherits="Projeto.Apresentacao.Forms.res_con_socio_exc" %>
...
<body>
    ...
    <div class="container body-content">
        <br /><br /><br /><br />
        Resultado da(s) Consulta(s) do(a)(s) Sócio(a)(s) para efetuar a(s) alteração(ões) do(e) seu(s) dado(s). 
