<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="res_fale.aspx.cs" Inherits="Projeto.Apresentacao.Forms.res_fale" %>
        ...
        <div>
            ...
            <%@Import Namespace="System.Data"  %>
                ...
                <%@Import Namespace="Projeto.Entidades"  %>    
                    <% /// Assembly Entidades e Conexao com a Base %>
            <%        
                ...
                /// Campo Nome do(a) Usuario(a) que vai fazer o Fale Conosco
                string E_mail = Request.Form["E_mail"];
                /// Campo E - mail do(a) Usuario(a) que vai fazer o Fale Conosco
                string Telefone = Request.Form["Telefone"];
                /// Campo Telefone do(a) Usuario(a) que vai fazer o Fale Conosco
                string Descricao = Request.Form["Descricao"];
                /// Campo Descricao do(a) Usuario(a) que vai fazer o Fale Conosco
                SqlCommand com = new SqlCommand("INSERT INTO FALE_CONOSCO (NOME, E_MAIL, TELEFONE, DESCRICAO) VALUES('" + Nome + "', '" + E_mail + "', '" + Telefone + "', '" + Descricao + "')", con);
                        /// Conversa com a Base
