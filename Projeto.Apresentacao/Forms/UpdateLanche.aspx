<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateLanche.aspx.cs" Inherits="Projeto.Apresentacao.Forms.UpdateLanche" %>
...
<body class="container">
    ...
    <hr />
            ...
            <%        
                ...
                L.Nome = Request.Form["Nome"].ToString();
                    /// Atributo Nome do Lanche
                L.Preco = Request.Form["Preco"].ToString();
                    /// Atributo Preco do Lanche
                string CodigoLanche = Request.Form["Codigo"];
                    /// Atributo Codigo do Lanche
                /// string senha = Convert.ToString(Request.QueryString["SENHA"]);
                
                SqlCommand com = new SqlCommand("UPDATE LANCHE SET NOME = '" + L.Nome + "', PRECO = '" + L.Preco + "' WHERE CODIGO_LANCHE = " + CodigoLanche, con);
                com.ExecuteNonQuery();
                    /// Conversa com a Base
                %>                    <br />
                                    <center><a href="../Usuario/Administrator">Voltar</a></center>
                                        <br />
                                                <center>Dados do Lanche Atualizados com Sucesso!</center>
                                                        <% /// Resultado da Pagina %>
                                           <%
                                           con.Close();
                                               /// Fecha a Conexao
